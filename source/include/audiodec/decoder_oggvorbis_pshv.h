...
#ifndef EASYRPG_AUDIO_DECODER_OGGVORBIS_PSHV_H
#define EASYRPG_AUDIO_DECODER_OGGVORBIS_PSHV_H
 ...
 */
class OggVorbisForPSHVDecoder : public AudioDecoder {
public:
	OggVorbisForPSHVDecoder();
