...
class Graphics {
	...
	public:
		 ...
		 * @par Usage example:
		 * @code
		 * Graphics.overloadImage(0, 32 * 32 * 4, pixels, image)
		 * @endcode
		 *
		 * @param image - Image to copies pixels onto.
		 * @param offset - Offset in bytes to which to copies pixels.
		 * @param size - Size in bytes of the pixels to copy.
