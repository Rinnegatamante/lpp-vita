...
public class Network {
	 ...
	 */
	public string getIPAdddress(void){}
	 ...
	 */
	public string getMacAdddress(void){}
	 ...
	 */
	public bool isWifiEnabled(void){}
	 ...
	 */
	public void downloadFile(string url, string file, string useragent, HTTPMethod method, string postdata){}
	 ...
	 * @note If not specified, \link HTTPMethod::GET_METHOD GET_METHOD\endlink is used as default.
	 */
	public string requestString(string url, string useragent, HTTPMethod method, string postdata){}
...
public class Socket {
	 ...
	 */
	public int createServerSocket(int port, NetProtocol protocol){}
	 ...
	 * @note If not specified, \link NetProtocol::TCP_SOCKET TCP_SOCKET\endlink is used as default.
	 */
	public int connect(string host, int port, NetProtocol protocol){}
	 ...
	 */
	public int send(int sock, string data){}
	 ...
	 */
	public string receive(int sock, int size){}
